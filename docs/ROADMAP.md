...
| 7a-ii | **Corrective** — "Gaps" meant two things across surfaces; SPA view renamed **Unresolved**, new **Coverage** view over `/api/gaps` | ✅ Complete (2026-08-02) — 729 tests, frontend 15 tests, lint clean, assets re-embedded; **screenshot QA could not be run this session** (both browser paths failed) — data contract and built bundle verified instead, manual checklist in the report |
