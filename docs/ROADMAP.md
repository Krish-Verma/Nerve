...
| 7a-iii | **Corrective** — the rail labels `entities_total` as "Symbols" (21 vs 9 real symbols, and it now counts `coverage_run`). Pre-existing from 4b, made visible by 7a-ii | ⬜ Not started |
