...
All 89 transitive dependencies are permissively licensed. Nothing is copyleft-encumbered for
...
Total: 89 third-party crates (`nerve-core`, `nerve-store`, `nerve-index` and `nerve-cli` are
this workspace and are excluded).
